...
# Version: 1.0
#
#  Version in which, when an order is not taken in the first queue, the second queue tries to capture it.
#
#
########################################################################################
    ...
    def step_env(self):
        ...
        for item in self.items_on_conv:
            if item[0] in self.diverter_locations:
                ...
                elif condition_2 and not condition_1 and condition_3:
