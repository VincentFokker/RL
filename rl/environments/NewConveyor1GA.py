...
class NewConveyor1GA(gym.Env):
    ...
    def step_env(self):
        ...
        for item in self.items_on_conv:
            if item[0] in self.diverter_locations:
                ...
                logging.debug('{},{},{}'.format(condition_1, condition_2,condition_3))
    ...
    def step(self, action):
        ...
        if self.cycle_count > self.max_cycle_count:
            self.terminate = True
            print('Terminate on cycle count')
