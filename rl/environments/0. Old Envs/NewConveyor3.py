...
class NewConveyor3(gym.Env):
    ...
    def make_observation(self):
        ...
        4. amount of items in queues
        5. - TODO amount of items that took a cycle
        ...
        # OR
        carrier_type_map_obs = type_map_obs[-1, -6:][::2]  ## returns: array([[3.],[3.],[3.]])                         # 3
        ...
        # 5 - cycle count
        obs = np.append(obs, np.array(self.cycle_count))
